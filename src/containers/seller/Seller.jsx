    ...
    <div className='seller-body'>
      <Header hidefooter={true} />
        ...
        <div style={{marginTop: '6em'}}>
         ...
         <div>
           <h2 style={{textAlign:'center', marginTop:'3em', padding:'0em 3em'}}>Selling on B2UM is easy like 1, 2, 3</h2>
           <p style={{textAlign:'center'}}>Literally, we only have three steps.</p>
          <div className='about-container' style={{backgroundColor:'white', color:'rgba(0,0,0,0.8)'}}>
